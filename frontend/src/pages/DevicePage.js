    ...
    >
      <Row>
        ...
        >
          <Image
            className={
              "align-self-center justify-self-center mx-auto d-block img-fluid"
            }
        ...
        <Col className={"d-flex flex-column"} md={8}>
          ...
          <Row className={"my-3  m-0 d-flex  align-items-baseline"}>
            <Typography
              className={"w-25 text-center align-self-center  rounded-5"}
              style={{
                minHeight: "80px",
                fontWeight: "lighter",
                fontStyle: "italic",
            ...
            <Button
              ...
              disabled={user.isAuth && user.user.role === "ADMIN"}
              onClick={() => addToCart()}
              className={"w-75"}
            >
              Добавить в корзину
