...
import cashPerspecitve from "../assets/money.png";
...
const MainPage = () => {
  ...
  return (
    <div className={"mx-auto  container-fluid p-0 overflow-hidden"}>
      <section
        style={sectionStyle}
        className={"d-flex  justify-content-center bg-light py-5 "}
      >
      ...
      <section
        style={sectionStyle}
        className={" d-flex justify-content-center py-5 bg-light"}
      >
        <Row className="align-items-center justify-content-center">
          <Col md={5} lg={5} className="px-4">
            <h1 className={"display-4 fw-bold  px-4"}>
